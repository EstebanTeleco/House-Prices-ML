...
```bash
git clone https://github.com/EstebanTeleco/House-Prices-ML.git
cd House-Prices-ML
...
Ejemplo real de una corrida (dataset completo de Kaggle, XGBoost ganó con RMSLE ≈ 0.13):

![Comparación de modelos](outputs/comparacion_modelos.png)

## Tests

Hay tests unitarios para las funciones de `src/` (limpieza de datos, features nuevas, elección del mejor modelo). No dependen de `train.csv`/`test.csv`, usan datos de prueba armados a mano, así que se pueden correr sin tener el dataset descargado:
